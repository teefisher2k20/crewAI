                    ...
                    <div class="accordion-content" id="class-content">
                        <div class="drawer-section">
                            <div class="code-block-container">
                                <button type="button" class="code-copy-button" data-code="${metadata.class_signature.replace(/"/g, "&quot;")}" aria-label="Copy code" title="Copy code">
    ...
    return `
            <div class="accordion-section expanded">
                ...
                <div class="accordion-content" id="source-code-content">
                    <div class="drawer-section">
                        <div class="code-block-container">
                            <button type="button" class="code-copy-button" data-code="${codeToHighlight.replace(/"/g, "&quot;")}" aria-label="Copy code" title="Copy code">
                                <svg class="copy-icon" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5">
                                    <rect x="5" y="5" width="9" height="9" rx="1.5" />
                                    <path d="M3 11V3a2 2 0 0 1 2-2h8" />
                                </svg>
