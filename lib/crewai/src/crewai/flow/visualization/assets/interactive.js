...
class DrawerManager {
  ...
  renderSourceCode(metadata) {
    const accordionId = `accordion-source-${Math.random().toString(36).substr(2, 9)}`;
    const contentId = `content-source-${Math.random().toString(36).substr(2, 9)}`;
    ...
    return `
            <div class="accordion-section expanded">
                <button type="button" class="accordion-header" id="${accordionId}" aria-expanded="true" aria-controls="${contentId}">
