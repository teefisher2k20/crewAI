    ...
    return `
            <div class="accordion-section expanded">
                ...
                <div class="accordion-content">
                    <div class="drawer-section">
                        <div class="code-block-container">
                            <button class="code-copy-button" type="button" aria-label="Copy code" title="Copy code" data-code="${codeToHighlight.replace(/"/g, "&quot;")}">
    ...
    copyButtons.forEach((button) => {
      button.addEventListener("click", () => {
        ...
        navigator.clipboard.writeText(codeText).then(() => {
          button.classList.add("copied"); button.setAttribute('aria-label', 'Copied!'); button.setAttribute('title', 'Copied!');
          setTimeout(() => { button.classList.remove("copied"); button.setAttribute('aria-label', 'Copy code'); button.setAttribute('title', 'Copy code'); }, 2000);
