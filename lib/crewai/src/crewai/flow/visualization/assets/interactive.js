...
class DrawerManager {
  ...
  renderSourceCode(metadata) {
    ...
    if (metadata.class_signature) {
      ...
      classSection = `
                <div class="accordion-section expanded">
                    <button type="button" class="accordion-subheader accordion-title" aria-expanded="true" aria-controls="accordion-class-content">Class</button>
                    <div id="accordion-class-content" class="accordion-content">
                        <div class="drawer-section">
    ...
    return `
            <div class="accordion-section expanded">
                <button type="button" class="accordion-header" aria-expanded="true" aria-controls="accordion-source-content">
                ...
                <div id="accordion-source-content" class="accordion-content">
                    <div class="drawer-section">
                        <div class="code-block-container">
