...
class DrawerManager {
  ...
  renderMetadata(metadata) {
    ...
    if (metadata.router_paths && metadata.router_paths.length > 0) {
      ...
      metadataContent += `
                <div class="drawer-section">
                    <button type="button" class="drawer-section-title router-paths-title" data-router-paths="${routerPathsJson}" style="cursor: pointer; display: inline-flex; align-items: center; gap: 4px; border: none; font-family: inherit; background: none; text-align: left; padding: 0;" aria-label="Highlight router paths">
    ...
    if (metadata.class_signature) {
      ...
      classSection = `
                <div class="accordion-section expanded">
                    <button type="button" class="accordion-subheader accordion-title" aria-expanded="true" aria-controls="class-content" style="width: 100%; border: none; font-family: inherit; background: #0d1117; text-align: left; cursor: pointer;">Class</button>
                    <div class="drawer-section accordion-content" id="class-content">
