  ...
  renderSourceCode(metadata) {
    ...
    return `
            <div class="accordion-section expanded">
                <button type="button" class="accordion-header" aria-expanded="true" aria-controls="${contentId}" id="${accordionId}">
                ...
                <div class="accordion-content" id="${contentId}" role="region" aria-labelledby="${accordionId}">
                    <div class="drawer-section">
                        <div class="code-block-container">
                            <button class="code-copy-button" data-code="${codeToHighlight.replace(/"/g, "&quot;")}" aria-label="Copy source code">
...
class NetworkManager {
  ...
  setupTheme() {
    ...
    const updateThemeIcon = (isDark) => {
      ...
      themeToggle.setAttribute("aria-label", label.toLowerCase());
