  ...
  renderSourceCode(metadata) {
    ...
    return `
            <div class="accordion-section expanded">
                <button type="button" class="accordion-header" aria-expanded="true" aria-controls="accordion-source-code">
                ...
                <div class="accordion-content" id="accordion-source-code">
                    <div class="drawer-section">
                        <div class="code-block-container">
...
class NetworkManager {
  ...
  setupTheme() {
    ...
    const updateThemeIcon = (isDark) => {
      ...
      const themeLabel = isDark ? "Toggle Light Mode" : "Toggle Dark Mode";
